...
public class CreateRDPQSub
{
	...
	public static final File FASTA_DIR = new File("/projects/afodor_research/topeControl/fastaOut");
	public static final File RDP_OUT_DIR = new File( "/projects/afodor_research/topeControl/rdpOut");
	public static final File RDP_RUN_DIR = new File("/projects/afodor_research/topeControl/scripts/rdpRun");
