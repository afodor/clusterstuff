 ...
 * -db /scratch/afodor_research/silva/SILVA_132_SSURef_tax_silva.fasta -out /scratch/afodor_research/datasets/uegp/dada2ToBlast/blastOut
  -outfmt 6
	 */
	public static File blastOutDir = new File("/nobackup/afodor_research/datasets/maigaTB_June2019/dada2Fasta/blastOut");
	public static File scriptsDir = new File("/nobackup/afodor_research/datasets/maigaTB_June2019/dada2Fasta/scripts");
