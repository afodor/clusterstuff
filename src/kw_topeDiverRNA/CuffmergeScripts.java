...
public class CuffmergeScripts {
	...
	private static String CUFFDIR = "/nobackup/afodor_research/kwinglee/tope/diverRNAseq/cufflinksHumanResults/";
	private static String HUMGFF = "/nobackup/afodor_research/kwinglee/hg38/GCF_000001405.36_GRCh38.p10_genomic.gff";
	private static String HUMFA = "/nobackup/afodor_research/kwinglee/hg38/hg38bowtie.fa";
	...
	public static void main(String[] args) throws IOException {
		...
		script.write("cuffmerge -o " + CUFFDIR + "cuffmerge" + " -g " + HUMGFF
				+ " -p 4 -s " + HUMFA + " " + gtfList + "\n");
		script.close();
	}
}
