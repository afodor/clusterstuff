...
public class CufflinksScripts {
	...
	private static String TOPHATDIR = BASEDIR + "tophatAlignToHuman/";
	private static String CUFF = "/nobackup/afodor_research/kwinglee/software/cufflinks-2.2.1.Linux_x86_64/cufflinks";
	private static String OUTDIR = BASEDIR + "cufflinksHumanResults/";
	private static String SCRIPTDIR = "/projects/afodor_research/kwinglee/scripts/tope/diverRNA/";
	...
	public static void main(String[] args) throws IOException {
		...
		for(String s : sams) {
			String scriptName = "cufflinks_" + s; 
			BufferedWriter script = new BufferedWriter(new FileWriter(new File(
					SCRIPTDIR + scriptName)));
			script.write("#PBS -l walltime=250:00:00\n");
