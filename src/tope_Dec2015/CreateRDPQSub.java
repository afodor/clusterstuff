...
public class CreateRDPQSub
{
	...
	public static final File FASTA_DIR = new File("/nobackup/afodor_research/topeDec2015/fastaOut");
	public static final File RDP_OUT_DIR = new File( "/nobackup/afodor_research/topeDec2015/rdpOut");
	public static final File RDP_RUN_DIR = new File("/nobackup/afodor_research/topeDec2015/rdpRun");
