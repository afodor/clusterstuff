...
public class WriteSparseThreeColumn
{
	...
	public static final File THREE_COL_DIR = new File("/projects/afodor_research/mbrown67/Carroll_Longitudinal/rdpThreeCol");
	public static final File RDP_OUT_DIR = new File("/projects/afodor_research/mbrown67/Carroll_Longitudinal/rdpOut2");
	
	public static void main(String[] args) throws Exception
	{
		File topDir = RDP_OUT_DIR;
		...
		for( int x=1; x < NewRDPParserFileLine.TAXA_ARRAY.length; x++)
		{
			 BufferedWriter writer = new BufferedWriter(
					 ...
					 THREE_COL_DIR.getAbsolutePath() + File.separator + 
