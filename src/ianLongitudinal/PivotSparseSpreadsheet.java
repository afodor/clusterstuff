...
public class PivotSparseSpreadsheet
{
	public static void main(String[] args) throws Exception
	{
		...
		for( int x=1; x < NewRDPParserFileLine.TAXA_ARRAY.length; x++)
		{
			...
			getMap(WriteSparseThreeColumn.THREE_COL_DIR	+ File.separator 
					+ NewRDPParserFileLine.TAXA_ARRAY[x] +"_SparseThreeCol.txt");
			
			File pivotedFile = 
					new File(
							WriteSparseThreeColumn.THREE_COL_DIR	+
			...
			wrapper.writeNormalizedLoggedDataToFile(WriteSparseThreeColumn.THREE_COL_DIR+
					File.separator + "pivoted_" + 
