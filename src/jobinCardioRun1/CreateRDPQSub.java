...
public class CreateRDPQSub
{
	...
	public static final File RDP_OUT_DIR = new File( "/projects/afodor_research/JobinCardio/rdpOutRun1");
	public static final File RDP_RUN_DIR = new File("/projects/afodor_research/JobinCardio/rdpRunDirRun1");
