...
public class Demultiplex
{
	public static File forwardSeqs = new File(
			"/projects/afodor_research/JobinCardio/*/Sample_1-26241227/Data/Intensities/BaseCalls/Sample-Name-1_S1_L001_R1_001.fastq.gz");
	
	public static File reverseSeqs = new File(
			"/projects/afodor_research/JobinCardio/*/Sample_1-26241227/Data/Intensities/BaseCalls/Sample-Name-1_S1_L001_R2_001.fastq.gz");
	
	public static File keyFile = new File(
			"/projects/afodor_research/JobinCardio/keys/Barcode Run1 8-6-2015.txt");
	
	public static File fastaOutDir = new File("/projects/afodor_research/JobinCardio/fastaOutRun1");
