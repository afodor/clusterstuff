...
public class parseRDPresults {
	public static final String DIR = "C:\\Users\\kwinglee.cb3614tscr32wlt\\Documents\\Fodor\\JobinCollaboration\\black tea\\rdpResults\\";
	
	public static void main(String[] args) throws IOException {
		//get hierarchical file results
		BufferedReader hier = new BufferedReader(new FileReader(new File(DIR + "blackTea_rdphierarch_merge.txt")));
