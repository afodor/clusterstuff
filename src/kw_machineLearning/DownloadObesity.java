...
public class DownloadObesity {
	public static String DIR = "/nobackup/afodor_research/kwinglee/machineLearning/obesity/";
	public static int NUMCMDS = 10;//number of downloads per script
	public static String SCRIPTDIR = "/projects/afodor_research/kwinglee/scripts/machineLearning/obesity/";
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader list = new BufferedReader(new FileReader(new File(
				DIR + "PRJEB4336.txt")));//contains the list of read files
