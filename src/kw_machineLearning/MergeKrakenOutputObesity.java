/*
 * Merge the kraken outputs for obesity 
...
public class MergeKrakenOutputObesity {
	public static String DIR = "/nobackup/afodor_research/kwinglee/machineLearning/obesity/minikraken/";
