...
public class WriteSparseThreeColumn
{
	...
	public static final File SPREADSHEETS_DIR = new File("/users/afodor/gaStool/spreadsheets");
	public static final File RDP_OUT_DIR = new  File("/users/afodor/gaStool/rdpResults");
