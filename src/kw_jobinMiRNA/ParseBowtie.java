/*
 * get count table from Bowtie alignments
 */
...
public class ParseBowtie {
	public static String DIR = "/nobackup/afodor_research/kwinglee/jobin/microRNA/miRBaseBowtie/";
	...
	public static void main(String[] args) throws IOException {
		...
		writeCounts(mature, "BowtieMature.txt");
		writeCounts(hairpin, "BowtieHairpin.txt");
	}
