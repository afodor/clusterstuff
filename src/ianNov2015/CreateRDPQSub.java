...
public class CreateRDPQSub
{
	...
	public static final File FASTA_DIR = new File("/projects/afodor_research/mbrown67/Carroll_Anorexia/fasta");
	public static final File RDP_OUT_DIR = new File( "/projects/afodor_research/mbrown67/Carroll_Anorexia/rdpOut");
	public static final File RDP_RUN_DIR = new File("/projects/afodor_research/mbrown67/Carroll_Anorexia/rdpRun");
