...
public class CreateRDPQSub
{
	...
	public static final File FASTA_DIR = new File("//nobackup/afodor_research/datasets/EvanFeb2018/demultiplexFastaA");
	public static final File RDP_OUT_DIR = new File( "/nobackup/afodor_research/datasets/EvanFeb2018/rdpOut");
	public static final File RDP_RUN_DIR = new File("/nobackup/afodor_research/datasets/EvanFeb2018/rdpRun");
