...
public class WriteContextScripts
{
	...
	static File OUTPUT_DIRECTORY = new File(
			"/nobackup/afodor_research/fromNury52016/test/context");
	
	private static File SCRIPT_DIRECTORY = new File(
			"/nobackup/afodor_research/fromNury52016/test/scripts");
	...
	public static void main(String[] args) throws Exception
	{
		...
		for(String s : files)
		{
			if ( s.endsWith(".fastq"))
			{
				...
				writer.write("java  -Xmx20g -cp /users/afodor/gitInstall/clusterstuff/bin cmcDistances.test.VerifyContif " + 
								 inFile.getAbsolutePath() + " " + outFile.getAbsolutePath() + " 15 15" 
								+"\n"
						);
