/*
 * Convert run2 4483 rerun joined reads from fastq to fasta
 */
package kw_meyer;
...
public class ConvertRun2JoinToFasta_4483rerun {
	...
	public static void main(String[] args) throws IOException {
		...
		for(File fq : fqs) {
			if(fq.getName().endsWith("join.fastq") && fq.getName().startsWith("rerun")) {
