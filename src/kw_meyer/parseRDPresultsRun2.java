...
public class parseRDPresultsRun2 {
	public static final String DIR = "C:\\Users\\kwinglee.cb3614tscr32wlt\\Documents\\Fodor\\Meyer\\Run2\\RDP and QIIME results\\";
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader hier = new BufferedReader(new FileReader(new File(DIR + "hierarch_merge_allrun2_with4483rerun.txt")));
		
		//set up output files
		BufferedWriter genus = new BufferedWriter(new FileWriter(new File(DIR + "rdpRun2_genus.txt")));
		BufferedWriter fam = new BufferedWriter(new FileWriter(new File(DIR + "rdpRun2_family.txt")));
		BufferedWriter order = new BufferedWriter(new FileWriter(new File(DIR + "rdpRun2_order.txt")));
		BufferedWriter cl = new BufferedWriter(new FileWriter(new File(DIR + "rdpRun2_class.txt")));
		BufferedWriter phy = new BufferedWriter(new FileWriter(new File(DIR + "rdpRun2_phylum.txt")));
