...
public class CreateRDPQSub
{
	...
	public static final File FASTA_DIR = new File("/nobackup/afodor_research/topeCombined/fastaOut");
	public static final File RDP_OUT_DIR = new File( "/nobackup/afodor_research/topeCombined/rdpOut");
	public static final File RDP_RUN_DIR = new File("/nobackup/afodor_research/topeCombined/scripts/rdpRun");
