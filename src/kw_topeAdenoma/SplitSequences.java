...
{
	public static final String DIR = "/projects/afodor_research/topeSep15/originalFiles/"; 
	...
	public static void main(String[] args) throws Exception
	{
		...
		BufferedReader read1 = new BufferedReader(new InputStreamReader( 
				new GZIPInputStream( new FileInputStream(DIR + 
		...
		if( writer == null)
		{
			writer = new BufferedWriter(
					new OutputStreamWriter(new GZIPOutputStream(new FileOutputStream(
						"/projects/afodor_research/kwinglee/tope/adenoma" + File.separator + 
